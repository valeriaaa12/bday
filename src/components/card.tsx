...
export default function BirthdayModal({
  ...
  return (
    ...
    >
      <div
        className="relative w-[min(92vw,760px)] rounded-2xl border-4 border-[#2c1a4b] bg-[#b28bd6] shadow-[0_8px_0_#2c1a4b]"
      ...
      >
        ...
        <div className="flex items-center justify-end gap-2 px-4 py-2 border-b-4 border-[#2c1a4b]">
          <div className="flex gap-2">
            <button
              type="button"
              className="w-6 h-6 rounded bg-white/80 grid place-items-center text-[#2c1a4b]"
              aria-label="Minimize"
            >
              –
            </button>
            ...
            <button
              type="button"
              className="w-6 h-6 rounded bg-white/90 hover:bg-white grid place-items-center text-[#2c1a4b] font-bold"
              aria-label="Close"
              onClick={onClose}            
            >
              x
        ...
        <div className="grid grid-cols-[1fr_auto] gap-6 bg-[#f3e4fd] p-6 md:p-8 rounded-b-xl">
          <div className="text-center col-span-2">
            <h2 className="text-2xl mb-1 text-[#2c1a4b]">{title}</h2>
            {children ?? (
              <p className="text-[#2c1a4b] mb-4">No soy muy buena con las palabras pero queria desearte feliz cumpleaños y que la pases bonito con las personas que te quieren.
