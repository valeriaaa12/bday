  ...
  return (
    <div className={`min-h-screen bg-[#2b124c] ${pixel.className}`}>
      <header className="max-w-5xl mx-auto px-4 pt-8 pb-4">
        <h1 className="text-center text-white text-3xl font-extrabold tracking-wide drop-shadow">
      ...
      {gameOver && (
        <div className="fixed inset-0 flex items-center justify-center bg-black/60">
          <div className={`rounded-2xl bg-white px-6 py-5 text-center max-w-sm shadow-2xl ${pixel.className}`}>
